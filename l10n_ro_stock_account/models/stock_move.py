...
class StockMove(models.Model):
    ...
    def _create_in_svl(self, forced_quantity=None):
        print('SVL:', self.env.context.get('valued_type', ''))
    ...
    def _is_reception_notice(self):
        ...
        return self.picking_id.notice and self.location_id.usage == 'supplier'and self._is_in()
    ...
    def _is_reception_notice_return(self):
        ...
        return self.picking_id.notice and self.location_dest_id.usage == 'supplier' and self._is_out()
    ...
    def _create_delivery_notice_return_svl(self, forced_quantity=None):
        svl = self.with_context(standard=True, valued_type='delivery_notice_return')._create_out_svl(forced_quantity)
        return svl
    ...
    def _create_plus_inventory_svl(self, forced_quantity=None):
        svl = self.with_context(standard=True, valued_type='plus_inventory')._create_in_svl(forced_quantity)
        return svl
    ...
    def _create_minus_inventory_svl(self, forced_quantity=None):
        svl = self.with_context(standard=True, valued_type='minus_inventory')._create_out_svl(forced_quantity)
        return svl
