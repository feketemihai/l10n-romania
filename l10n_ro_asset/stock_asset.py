...
class account_asset_asset(models.Model):
    ...
    inventory_number = fields.Char(string='Inventory Number', store=True, readonly=True, states={'draft':[('readonly',False)]}, copy=False)
    inventory_value = fields.Float(string='Inventory Value', related='stock_move_id.price_unit', store=True, readonly=True, states={'draft':[('readonly',False)]}, copy=False)
