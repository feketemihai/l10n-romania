...
class account_compensation(osv.osv):
    ...
    def compensation_move_line_create(self, cr, uid, compensation_id, move_id, company_currency, current_currency, context=None):
        ...
        '''
        rec_lst_ids = super(account_compensation, self).compensation_move_line_create(cr, uid, compensation_id, move_id, company_currency, current_currency, context=context)
        if context is None:
            context = {}
