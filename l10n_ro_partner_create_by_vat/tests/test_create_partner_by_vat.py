...
class TestCreatePartner(TestCreatePartnerBase):
    ...
    def test_onchange_vat_anaf(self):
        ...
        with self.env.do_in_onchange():
            ...
            self.assertEqual(self.mainpartner.state_id, self.env.ref("l10n_ro.RO_TM"))
            ...
            self.assertEqual(self.mainpartner.street, "Principala Românești Nr.69/A")
            self.assertEqual(self.mainpartner.state_id, self.env.ref("l10n_ro.RO_TM"))
