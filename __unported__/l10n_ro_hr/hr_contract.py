...
class hr_contract(models.Model):
    ...
    work_hour = fields.Selection(
        [("6", "6 ore"), ("7", "7 ore"), ("8", "8 ore")],
        string="Hour per day",
        required=True,
        help="The numbers of hours/day",
    )
    work_type = fields.Selection(
        [("1", "Conditii normale"), ("2", "Conditii deosebite"), ("3", "Conditii Speciale")],
        string="Work type",
        required=True,
        help="The work type based on conditions",
    )
    insurance_type = fields.Many2one("hr.insurance.type", string="Insurance type", required=True, help="Insurance type")
