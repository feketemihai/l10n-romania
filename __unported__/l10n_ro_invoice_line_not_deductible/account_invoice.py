            ...
            if line.not_deductible:
                ...
                for tax in taxes:
                    ...
                    if not new_tax.not_deductible_tax_id:
                        raise except_orm(
                            _("Warning!"), _("You must define a not deductible " "tax on '%s'!") % (tax["name"],)
                        )
                    ...
                    mres["account_id"] = inv.company_id and inv.company_id.property_undeductible_tax_account_id.id
