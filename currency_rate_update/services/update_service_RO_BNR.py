...
class RO_BNR_getter(Currency_getter_interface):
    ...
    def rate_retrieve(self, dom, ns, curr, rate_date):
        ...
        currencies data"""
        res = {}
        xpath_rate_currency = "/def:DataSet/def:Body/def:Cube[@date='%s']/def:Rate[@currency='%s']/text()" % (rate_date, curr.upper())
        xpath_rate_ref = "/def:DataSet/def:Body/def:Cube[@date='%s']/def:Rate[@currency='%s']/@multiplier" % (rate_date, curr.upper())
    ...
    def get_updated_all_year(self, currency_array, main_currency):
        ...
        self.supported_currency_array = dom.xpath("/def:DataSet/def:Body/def:Cube[@date='%s']/def:Rate/@currency" % rate_date_array[0], 
