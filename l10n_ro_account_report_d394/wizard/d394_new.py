...
class d394_new_report(models.TransientModel):
    ...
    def _get_xml_data(self):
        if self._context.get('file_save', False):
            return base64.encodestring(self._context['file_save'].encode('utf8'))
        return ''
    ...
    def _get_deafult_company(self):
        self.company_id = self.env['res.company']._company_default_get('l10n_ro_account_report_d394.d394_new.report')

    file_save = fields.Binary('Save File', default='_get_xml_data')
    name = fields.Char('File Name', compute='_get_name')
    msg = fields.Text('File created', readonly=True, default='Save the File with '".xml"' extension.')
    company_id = fields.Many2one('res.company', 'Company', required=True, change_default=True,
                                 default=_get_deafult_company)
    period_id = fields.Many2one('account.period', 'Period', required=True, change_default=True,
                                default=_get_default_period)
    date_from = fields.Date('Date From', required=True)
    date_to = fields.Date('Date To', required=True)
    anaf_cross_opt = fields.Boolean('ANAF Crosschecking', related='company_id.anaf_cross_opt')
    anaf_cross_new_opt = fields.Boolean('Allow ANAF Crosschecking')
    solicit = fields.Boolean('Request VAT Reimbursment')
    achizitiiPE = fields.Boolean('Purchases of Eolian Parks', help='Achizitii de bunuri si servicii legate direct de'
                                                                   ' bunurile imobile: Parcuri Eoliene')
    achizitiiCR = fields.Boolean('Purchases of Residential Buildings',
                                 help='Achizitii de bunuri si servicii legate direct de'
                                      ' bunurile imobile: constructii rezidentiale')
    achizitiiCB = fields.Boolean('Purchases of Office Buildings',
                                 help='Achizitii de bunuri si servicii legate direct de'
                                      ' bunurile imobile: cladiri de birouri')
    achizitiiCI = fields.Boolean('Purchases of Industrial Buildings',
                                 help='Achizitii de bunuri si servicii legate direct de'
                                      ' bunurile imobile: constructii industriale')
    achizitiiA = fields.Boolean('Purchases of Real Estates: Others',
                                help='Achizitii de bunuri si servicii legate direct de'
                                     ' bunurile imobile: altele')
    achizitiiB24 = fields.Boolean('Purchased Goods with 24% VAT',
                                  help='Achizitii de bunuri, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 24%')
    achizitiiB20 = fields.Boolean('Purchased Goods with 20% VAT',
                                  help='Achizitii de bunuri, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 20%')
    achizitiiB19 = fields.Boolean('Purchased Goods with 19% VAT',
                                  help='Achizitii de bunuri, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 19%')
    achizitiiB9 = fields.Boolean('Purchased Goods with 9% VAT',
                                 help='Achizitii de bunuri, cu exceptia celor legate direct'
                                      ' de bunuri imobile cu cota 9%')
    achizitiiB5 = fields.Boolean('Purchased Goods with 5% VAT',
                                 help='Achizitii de bunuri, cu exceptia celor legate direct'
                                      ' de bunuri imobile cu cota 5%')
    achizitiiS24 = fields.Boolean('Purchased Services with 24% VAT',
                                  help='Achizitii de servicii, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 24%')
    achizitiiS20 = fields.Boolean('Purchased Services with 20% VAT',
                                  help='Achizitii de servicii, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 20%')
    achizitiiS19 = fields.Boolean('Purchased Services with 19% VAT',
                                  help='Achizitii de servicii, cu exceptia celor legate direct'
                                       ' de bunuri imobile cu cota 19%')
    achizitiiS9 = fields.Boolean('Purchased Services with 9% VAT',
                                 help='Achizitii de servicii, cu exceptia celor legate direct'
                                      ' de bunuri imobile cu cota 9%')
    achizitiiS5 = fields.Boolean('Purchased Services with 5% VAT',
                                 help='Achizitii de servicii, cu exceptia celor legate direct'
                                      ' de bunuri imobile cu cota 5%')
    importB = fields.Boolean('Purchase Goods - Imports', help='Importuri de bunuri')
    acINecorp = fields.Boolean('Purchase of Intangible Assets', help='Achizitii imobilizari necorporale')
    livrariBI = fields.Boolean('Sales from Real Estates', help='Livrari de bunuri imobile')
    BUN24 = fields.Boolean('Sales Goods with 24% VAT', help='Livrari de bunuri, cu exceptia bunurilor'
                                                            ' imobile cu cota de 24%')
    BUN20 = fields.Boolean('Sales Goods with 20% VAT', help='Livrari de bunuri, cu exceptia bunurilor'
                                                            ' imobile cu cota de 20%')
    BUN19 = fields.Boolean('Sales Goods with 19% VAT', help='Livrari de bunuri, cu exceptia bunurilor'
                                                            ' imobile cu cota de 19%')
    BUN9 = fields.Boolean('Sales Goods with 9% VAT', help='Livrari de bunuri, cu exceptia bunurilor'
                                                          ' imobile cu cota de 9%')
    BUN5 = fields.Boolean('Sales Goods with 5% VAT', help='Livrari de bunuri, cu exceptia bunurilor'
                                                          ' imobile cu cota de 5%')
    valoareScutit = fields.Boolean('Sales Goods exempt from VAT', help='Livrari de bunuri scutite de TVA')
    BunTI = fields.Boolean('Sales Goods with Inverse Taxation', help='Livrari de bunuri/prestari de servicii pt care'
                                                                     ' se aplica taxarea inversa')
    Prest24 = fields.Boolean('Sales Services with 24% VAT', help='Prestari de servicii cu cota de 24%')
    Prest20 = fields.Boolean('Sales Services with 20% VAT', help='Prestari de servicii cu cota de 20%')
    Prest19 = fields.Boolean('Sales Services with 19% VAT', help='Prestari de servicii cu cota de 19%')
    Prest9 = fields.Boolean('Sales Services with 9% VAT', help='Prestari de servicii cu cota de 9%')
    Prest5 = fields.Boolean('Sales Services with 5% VAT', help='Prestari de servicii cu cota de 5%')
    PrestScutit = fields.Boolean('Sales Services exempt from VAT', help='Prestari de servicii scutite de TVA')
    LIntra = fields.Boolean('Sales Goods - Intra-Community', help='Livrari intracomunitare de bunuri')
    PrestIntra = fields.Boolean('Sales Services - Intra-Community', help='Prestari intracomunitare de servicii')
    Export = fields.Boolean('Sales Goods - Exports', help='Exporturi de bunuri')
    livINecorp = fields.Boolean('Sales of Intangible Assets', help='Livrari imobilizari necorporale')
    ...
    def _update_partners(self):
        ...
        if invoices:
            partners = self.env['res.partner'].browse(set(invoices.mapped('partner_id.id')))
    ...
    def _get_inv_lines(self, invoices, sel_cota, domain):
        ...
        if invoices:
            ...
            cota_amount = 0
            for cota in cotas:
                cota_inv = invs.filtered(lambda r: cota.id in r.tax_ids.ids)
                cota_amount = 0
    ...
    def _get_payments(self):
        ...
        invoices = invoice_obj.search(where, order="type desc, date_invoice, number")
                ...
                for payment in inv1.payment_ids:
                    if payment.period_id.id == period.id and payment.move_id.date <= self.date_to:
                        ...
                        for line in payment.move_id.line_id:
                            if ('4427' in line.account_id.code) or ('4426' in line.account_id.code):
                                if line.tax_code_id and ' 24' in line.tax_code_id.name:
                                    pay['base_24'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit) / 0.24, comp_curr)
                                    pay['tva_24'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit), comp_curr)
                                if line.tax_code_id and ' 20' in line.tax_code_id.name:
                                    pay['base_20'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit) / 0.20, comp_curr)
                                    pay['tva_20'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit), comp_curr)
                                if line.tax_code_id and ' 19' in line.tax_code_id.name:
                                    pay['base_19'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit) / 0.09, comp_curr)
                                    pay['tva_19'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit), comp_curr)
                                if line.tax_code_id and ' 9' in line.tax_code_id.name:
                                    pay['base_9'] += inv1.currency_id.with_context(ctx).compute(
                                        (line.credit or line.debit) / 0.09, comp_curr)
                                    pay['tva_9'] += inv1.currency_id.with_context(
                                        ctx).compute((line.credit or line.debit), comp_curr)
                                if line.tax_code_id and ' 5' in line.tax_code_id.name:
                                    pay['base_5'] += inv1.currency_id.with_context(
                                        ctx).compute((line.credit or line.debit) / 0.05, comp_curr)
                                    pay['tva_5'] += inv1.currency_id.with_context(
                                        ctx).compute((line.credit or line.debit), comp_curr)
                        for field in (
                                'base_24', 'base_20', 'base_19', 'base_9', 'base_5', 'tva_24', 'tva_20', 'tva_19',
                                'tva_9',
                                'tva_5'):
    ...
    def _generate_informatii(self, invoices, payments, op1, op2):
        informatii = {}
        informatii['nrCui1'] = len(set(op['cuiP'] for op in op1 if op['tip_partener'] == '1'))
        informatii['nrCui2'] = len([op for op in op1 if op['tip_partener'] == '2'])
        informatii['nrCui3'] = len(set(op['cuiP'] for op in op1 if op['tip_partener'] == '3'))
        informatii['nrCui4'] = len(set(op['cuiP'] for op in op1 if op['tip_partener'] == '4'))
        informatii['nr_BF_i1'] = sum(op['nrBF'] for op in op2 if op['tip_op2'] == 'I1')
        informatii['incasari_i1'] = sum(op['total'] for op in op2 if op['tip_op2'] == 'I1')
        informatii['incasari_i2'] = sum(op['total'] for op in op2 if op['tip_op2'] == 'I2')
        informatii['nrFacturi_terti'] = len(set(invoices.filtered(lambda r: r.sequence_type == 'autoinv2')))
        informatii['nrFacturi_benef'] = len(set(invoices.filtered(lambda r: r.sequence_type == 'autoinv1')))
        informatii['nrFacturi'] = len(invoices)
        informatii['nrFacturiL_PF'] = len(
            set(invoices.filtered(lambda r: r.operation_type == 'L' and r.partner_type == '2' and \
                                            r.amount_total <= 10000)))
        informatii['nrFacturiLS_PF'] = len(
            set(invoices.filtered(lambda r: r.operation_type == 'LS' and r.partner_type == '2' and \
                                            r.amount_total <= 10000)))
        informatii['val_LS_PF'] = int(round(sum(inv.amount_total for inv in invoices.filtered(
            lambda r: r.operation_type == 'LS' and r.partner_type == '2' and r.amount_total <= 10000))))
        informatii['tvaDedAI24'] = int(round(sum(
            op['tva_24'] for op in payments if
            op['type'] in ('in_invoice', 'in_refund') and op['vat_on_payment'] is True)))
        informatii['tvaDedAI20'] = int(round(sum(
            op['tva_20'] for op in payments if
            op['type'] in ('in_invoice', 'in_refund') and op['vat_on_payment'] is True)))
        informatii['tvaDedAI19'] = int(round(sum(op['tva_19'] for op in payments if
                                                 op['type'] in ('in_invoice', 'in_refund') and op[
                                                     'vat_on_payment'] is True)))
        informatii['tvaDedAI9'] = int(
            round(sum(op['tva_9'] for op in payments if op['type'] in ('in_invoice', 'in_refund') and op[
                'vat_on_payment'] is True)))
        informatii['tvaDedAI5'] = int(round(sum(op['tva_5'] for op in payments if
                                                op['type'] in ('in_invoice', 'in_refund') and op[
                                                    'vat_on_payment'] is True)))
        ...
        if comm_partner.with_context(ctx)._check_vat_on_payment():
            informatii['tvaDed24'] = int(round(sum(op['tva_24'] for op in payments if
                                                   op['type'] in ('in_invoice', 'in_refund') and op[
                                                       'vat_on_payment'] is False)))
            informatii['tvaDed20'] = int(round(sum(op['tva_20'] for op in payments if
                                                   op['type'] in ('in_invoice', 'in_refund') and op[
                                                       'vat_on_payment'] is False)))
            informatii['tvaDed19'] = int(round(sum(op['tva_19'] for op in payments if
                                                   op['type'] in ('in_invoice', 'in_refund') and op[
                                                       'vat_on_payment'] is False)))
            informatii['tvaDed9'] = int(round(sum(op['tva_9'] for op in payments if
                                                  op['type'] in ('in_invoice', 'in_refund') and op[
                                                      'vat_on_payment'] is False)))
            informatii['tvaDed5'] = int(round(sum(op['tva_5'] for op in payments if
                                                  op['type'] in ('in_invoice', 'in_refund') and op[
                                                      'vat_on_payment'] is False)))
            informatii['tvaCol24'] = int(round(sum(op['tva_24'] for op in payments if
                                                   op['type'] in ('out_invoice', 'out_refund') and op[
                                                       'vat_on_payment'] is True)))
            informatii['tvaCol20'] = int(
                round(sum(op['tva_20'] for op in payments if op['type'] in ('out_invoice', 'out_refund') and \
                          op['vat_on_payment'] is True)))
            informatii['tvaCol19'] = int(
                round(sum(op['tva_19'] for op in payments if op['type'] in ('out_invoice', 'out_refund') and \
                          op['vat_on_payment'] is True)))
            informatii['tvaCol9'] = int(
                round(sum(op['tva_9'] for op in payments if op['type'] in ('out_invoice', 'out_refund') and \
                          op['vat_on_payment'] is True)))
            informatii['tvaCol5'] = int(
                round(sum(op['tva_5'] for op in payments if op['type'] in ('out_invoice', 'out_refund') and \
                          op['vat_on_payment'] is True)))
    ...
    def _get_op1(self, invoices):
        ...
        for oper_type in oper_types:
            ...
            partner_types = set([invoice.partner_type for invoice in oper_type_inv])
            for partner_type in partner_types:
                part_type_inv = oper_type_inv.filtered(lambda r: r.partner_type == partner_type)
                cotas = []
                for invoice in part_type_inv:
                    cotas += set([tax.id for tax in invoice.tax_ids])
                cotas = set(cotas)
                for cota in obj_tax.browse(cotas):
                    cota_inv = part_type_inv.filtered(lambda r: cota.id in r.tax_ids.ids)
                    ...
                    for partner in obj_partner.browse(partners):
                        part_invoices = cota_inv.filtered(lambda r: r.partner_id.id == partner.id)
                        cota_amount = 0
                        if cota.type == 'percent':
                            if cota.child_ids:
                                cota_amount = int(abs(cota.child_ids[0].amount) * 100)
                        ...
                        if partner_type == '2':
                            if oper_type == 'N':
                                ...
                                for doc_type in doc_types:
                                    ...
                                    for inv_line in inv_lines:
                                        ...
                                        if not fp or (('National' in fp.name) or ('Invers' in fp.name) or (
                                                    'Scutit' in fp.name)):
                                            tax = inv_line.invoice_line_tax_id
                                            if cota.id in tax.ids:
                                                filtered_inv_lines.append(inv_line.id)
                                    ...
                                    for line in inv_lines:
                                        ...
                                        baza += inv_curr.with_context({'date': inv_date}).compute(line.price_subtotal,
                                                                                                  comp_curr)
                                    taxes = 0
                                    new_dict = {
                                        'tip': oper_type,
                                        ...
                                        'nrFact': len(set([line.invoice_id.id for line in inv_lines])),
                                        'baza': int(round(baza)),
                                ...
                                for inv_line in inv_lines:
                                    ...
                                    if not fp or (('National' in fp.name) or ('Invers' in fp.name) or (
                                                ('Scutit' in inv.fiscal_position.name) and inv.partner_type in (
                                            '1', '2'))):
                                        tax = inv_line.invoice_line_tax_id
                                        if cota.id in tax.ids:
                                            filtered_inv_lines.append(inv_line.id)
                                ...
                                taxes = 0
                                for line in inv_lines:
                                    inv_curr = line.invoice_id.currency_id.with_context({'date': inv_date})
                                    inv_date = line.invoice_id.date_invoice
                                    baza += inv_curr.compute(line.price_subtotal, comp_curr)
                                    taxes += inv_curr.compute(
                                        line.price_normal_taxes and line.price_normal_taxes or line.price_taxes,
                                        comp_curr)
                                new_dict = {
                                    'tip': oper_type,
                                    'tip_partener': partner_type,
                            ...
                            if not partner.is_company:
                                if partner.vat:
                                    ...
                                    if partner.country_id:
                                        new_dict['taraP'] = partner.country_id and partner.country_id.code.upper()
                                    if partner.city_id:
                                        new_dict['locP'] = partner.city_id and partner.city_id.name
                                    if partner.state_id:
                                        new_dict['judP'] = partner.state_id and partner.state_id.order_code
                                    if partner.street:
                                        new_dict['strP'] = partner.add_street and partner.add_street
                                    if partner.add_number:
                                        new_dict['nrP'] = partner.add_number and partner.add_number
                                    if partner.add_block:
                                        new_dict['blP'] = partner.add_block and partner.add_block
                                    if partner.add_flat:
                                        new_dict['apP'] = partner.add_flat and partner.add_flat
                                    if partner.street2:
                            ...
                            for inv_line in inv_lines:
                                ...
                                inv = inv_line.invoice_id
                                if not fp or (('National' in fp.name) or ('Invers' in fp.name) or (
                                            ('Scutit' in inv.fiscal_position.name) and inv.partner_type == '2')):
                                    tax = inv_line.invoice_line_tax_id
                                    if cota.id in tax.ids:
                                        filtered_inv_lines.append(inv_line.id)
                                elif not fp or ('Scutit' not in inv.fiscal_position.name):
                                    inv_type = inv_line.invoice_id.type
                                    if inv_type in ('out_invoice', 'out_refund'):
                                        tax = inv_line.product_id.taxes_id
                                    if cota.id in tax.ids:
                            ...
                            for line in inv_lines:
                                ...
                                inv_date = line.invoice_id.date_invoice
                                baza += inv_curr.compute(line.price_subtotal, comp_curr)
                                if line.invoice_id.operation_type in ('L', 'A', 'AI'):
                                    taxes += inv_curr.compute(line.price_taxes, comp_curr)
                            ...
                            new_dict = {
                                ...
                                'tip_partener': partner_type,
                                'cota': cota_amount,
                                'cuiP': partner.vat and partner._split_vat(partner.vat)[1] or '-',
                                'denP': partner.name.replace('&', '-').replace('"', ''),
                        ...
                        if inv_lines:
                            ...
                            op11 = []
                            if (partner_type == '1' and oper_type in ('V', 'C')) or (
                                ...
                                for code in codes:
                                    ...
                                    if partner_type == '1':
                                        cod_lines = [line for line in inv_lines.filtered(
                                            lambda r: r.product_id.d394_id.id == code.id and new_code.name <= '31')
                                                     ]
                                    else:
                                        cod_lines = [line for line in
                                                     inv_lines.filtered(lambda r: r.product_id.d394_id.id == code.id)
                                                     ]
                                    if cod_lines:
                                        nrFact = len(set([line.invoice_id.id for line in inv_lines.filtered(
                                            lambda r: r.product_id.d394_id.id == code.id)]))
                                        baza1 = 0
                                        taxes1 = 0
                                        for line in inv_lines:
                                            inv_curr = line.invoice_id.currency_id.with_context({'date': inv_date})
                                            inv_date = line.invoice_id.date_invoice
                                            baza1 += inv_curr.compute(line.price_subtotal, comp_curr)
                                            if oper_type == 'C':
                                                taxes1 += inv_curr.compute(
                                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes,
                                                    comp_curr)
                                        op11_dict = {'codPR': code.name, 'nrFactPR': nrFact, 'bazaPR': int(round(baza1))
                                                     }
                                        if oper_type in ('A', 'L', 'C', 'AI'):
    ...
    def _get_op2(self, invoices):
        self.ensure_one()
        if fields.Date.from_string(self.date_from) < fields.Date.from_string('2016-10-01'):
            return []
        obj_inv_line = self.env['account.invoice.line']
        ...
        for period in obj_period.browse(periods):
            period_inv = invoices.filtered(lambda r: r.period_id.id == period.id)
            nrAMEF = len(set([invoice.journal_id.id for invoice in period_inv]))
            nrBF = len(period_inv)
            total = 0
            ...
            for invoice in period_inv:
                ...
                for cota in cotas:
                    cota_inv = period_inv.filtered(lambda r: cota.id in r.tax_ids.ids)
                    cota_amount = 0
                    if cota.type == 'percent':
                        if cota.child_ids:
                            cota_amount = int(abs(cota.child_ids[0].amount) * 100)
                    ...
                    if cota_amount in (5, 9, 19, 20):
                        ...
                        for line in inv_lines:
                            ...
                            inv_date = line.invoice_id.date_invoice
                            if cota_amount == 20:
                                baza20 += inv_curr.compute(line.price_subtotal, comp_curr)
                                tva20 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            if cota_amount == 19:
                                baza19 += inv_curr.compute(line.price_subtotal, comp_curr)
                                tva19 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            elif cota_amount == 9:
                                baza9 += inv_curr.compute(line.price_subtotal, comp_curr)
                                tva9 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            elif cota_amount == 5:
                                baza5 += inv_curr.compute(line.price_subtotal, comp_curr)
                                tva5 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
            op2.append({
                'tip_op2': oper_type,
    ...
    def generate_rezumat1(self, invoices, op1s):
        ...
        if cota_amount != 0:
            rezumat1['facturiL'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'L')))
            rezumat1['bazaL'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'L')))
            rezumat1['tvaL'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'L')))
        if partner_type == '1' and cota_amount == 0:
            rezumat1['facturiLS'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'LS')))
            rezumat1['bazaLS'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'LS')))
        if partner_type == '1' and cota_amount != 0:
            rezumat1['facturiA'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'A')))
            rezumat1['bazaA'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'A')))
            rezumat1['tvaA'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'A')))
        if partner_type == '1' and cota_amount != 0:
            rezumat1['facturiAI'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'AI')))
            rezumat1['bazaAI'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'AI')))
            rezumat1['tvaAI'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'AI')))
        if partner_type in ('1', '3', '4') and cota_amount == 0:
            rezumat1['facturiAS'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'AS')))
            rezumat1['bazaAS'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'AS')))
        if (partner_type == '1') and (cota_amount == 0):
            rezumat1['facturiV'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'V')))
            rezumat1['bazaV'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'V')))
            # rezumat1['tvaV'] = int(round(sum(
            #    op['tva'] for op in op1s if op['tip'] == 'V')))
        if (partner_type != '2') and (cota_amount != 0):
            rezumat1['facturiC'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'C')))
            rezumat1['bazaC'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'C')))
            rezumat1['tvaC'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'C')))
        if op1s[0]['tip_partener'] == '2' and ('tip_document' in op1s[0]):
            rezumat1['facturiN'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'N')))
            rezumat1['document_N'] = op1s[0]['tip_document']
            rezumat1['bazaN'] = int(round(sum(op['baza'] for op in op1s.filtered(lambda r: r['tip'] == 'N'))))
        rez_detaliu = []
        for op1 in op1s:
            if op1['op11']:
                for line in op1['op11']:
                    ...
                    if rez_detaliu:
                        ...
                        if found:
                            ...
                            if op1['tip'] == 'L':
                                val['nrLiv'] = val['bazaLiv'] = val['tvaLiv'] = 0
                            if op1['tip'] == 'V' and op1['cota'] == 0:
                                val['nrLivV'] = val['bazaLivV'] = 0
                            # val['tvaLivV'] = 0
                            if op1['tip'] == 'A':
                                val['nrAchiz'] = val['bazaAchiz'] = val['tvaAchiz'] = 0
                            if op1['tip'] == 'AI':
                                val['nrAchizAI'] = val['bazaAchizAI'] = val['tvaAchizAI'] = 0
                            if op1['tip'] == 'C' and op1['cota'] != 0:
                                val['nrAchizC'] = val['bazaAchizC'] = val['tvaAchizC'] = 0
                            if partner_type == '2':
                                val['nrN'] = val['valN'] = 0
                            if op1['tip'] == 'L':
                                val['nrLiv'] += int(round(line['nrFactPR']))
    ...
    def _generate_rezumat1(self, invoices, payments, op1, op2):
        ...
        for partner_type in partner_types:
            cotas = set([x['cota'] for x in op1 if x['tip_partener'] == partner_type])
            for cota in cotas:
                op1s = []
                if partner_type == '2':
                    doc_types = set(
                        [x['tip_document'] for x in op1 if x['tip_partener'] == partner_type and x['tip'] == 'N'])
                    for doc_type in doc_types:
                        op1s = [x for x in op1 if x['tip_partener'] == partner_type and \
                                x['cota'] == cota and x['tip_document'] == doc_type]
                    if op1s:
                        rezumat1.append(self.generate_rezumat1(invoices, op1s))
                    op1s = [x for x in op1 if
                            x['tip_partener'] == partner_type and x['cota'] == cota and x['tip'] != 'N']
                else:
                    op1s = [x for x in op1 if x['tip_partener'] == partner_type and \
                            x['cota'] == cota]
                if op1s:
    ...
    def generate_rezumat2(self, sel_cota, invoices, op1s, op2):
        ...
        if op1s:
            ...
            fr_inv = domain = "r.operation_type == 'L' and r.fiscal_receipt is True"
            inv_lines = self._get_inv_lines(invoices, cota_amount, domain)
            if inv_lines:
                rezumat2['bazaBFAI'] = int(round(
                    sum(line.price_subtotal for line in inv_lines if not line.invoice_id.journal_id.fiscal_receipt)))
                rezumat2['TVABFAI'] = int(
                    round(sum(line.price_normal_taxes and line.price_normal_taxes or line.price_taxes \
                              for line in inv_lines if not line.invoice_id.journal_id.fiscal_receipt)))
            rezumat2['nrFacturiL'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'L')))
            rezumat2['bazaL'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'L')))
            rezumat2['tvaL'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'L')))
            rezumat2['nrFacturiA'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] in ('A', 'C'))))
            rezumat2['bazaA'] = int(round(sum(op['baza'] for op in op1s if op['tip'] in ('A', 'C'))))
            rezumat2['tvaA'] = int(round(sum(op['tva'] for op in op1s if op['tip'] in ('A', 'C'))))
            rezumat2['nrFacturiAI'] = int(round(sum(op['nrFact'] for op in op1s if op['tip'] == 'AI')))
            rezumat2['bazaAI'] = int(round(sum(op['baza'] for op in op1s if op['tip'] == 'AI')))
            rezumat2['tvaAI'] = int(round(sum(op['tva'] for op in op1s if op['tip'] == 'AI')))
            if cota_amount == 5:
                rezumat2['baza_incasari_i1'] = int(round(sum(x['baza5'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['tva_incasari_i1'] = int(round(sum(x['TVA5'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['baza_incasari_i2'] = int(round(sum(x['baza5'] for x in op2 if x['tip_op2'] == 'I2')))
                rezumat2['tva_incasari_i2'] = int(round(sum(x['TVA5'] for x in op2 if x['tip_op2'] == 'I2')))
            if cota_amount == 9:
                rezumat2['baza_incasari_i1'] = int(round(sum(x['baza9'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['tva_incasari_i1'] = int(round(sum(x['TVA9'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['baza_incasari_i2'] = int(round(sum(x['baza9'] for x in op2 if x['tip_op2'] == 'I2')))
                rezumat2['tva_incasari_i2'] = int(round(sum(x['TVA9'] for x in op2 if x['tip_op2'] == 'I2')))
            if cota_amount == 20:
                rezumat2['baza_incasari_i1'] = int(round(sum(x['baza20'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['tva_incasari_i1'] = int(round(sum(x['TVA20'] for x in op2 if x['tip_op2'] == 'I1')))
                rezumat2['baza_incasari_i2'] = int(round(sum(x['baza20'] for x in op2 if x['tip_op2'] == 'I2')))
                rezumat2['tva_incasari_i2'] = int(round(sum(x['TVA20'] for x in op2 if x['tip_op2'] == 'I2')))
            domain = "r.operation_type == 'L' and                 r.partner_type == '2' and r.amount_total <= 10000"
            inv_lines = self._get_inv_lines(invoices, cota_amount, domain)

            if inv_lines:
                rezumat2['bazaL_PF'] = int(round(sum(line.price_subtotal for line in inv_lines)))
                rezumat2['tvaL_PF'] = int(
                    round(sum(line.price_normal_taxes and line.price_normal_taxes or line.price_taxes \
                              for line in inv_lines)))
        else:
    ...
    def _get_inv_series(self):
        self.ensure_one()
        if fields.Date.from_string(self.date_to) < fields.Date.from_string('2016-10-01'):
            return []
        ...
        for sequence in sequences:
            serie = sequence._interpolate(sequence.prefix, sequence.with_context(ctx)._interpolation_dict_context())
            ...
            if partner:
                ...
                seq['cui'] = partner._split_vat(partner.vat)[1]
            if tip == 1:
                seq_dict.append(seq)
            seq1 = seq.copy()
            if sequence.sequence_type == 'normal':
                ...
                tip = 4
            inv = invoices.filtered(lambda r: r.journal_id.sequence_id.id == sequence.id).sorted(
    ...
    def _generate_lista(self):
        ...
        lista = []
        invoices = obj_invoice.search([('type', 'in', ['out_invoice', 'out_refund']),
                                       ('state', 'in', ['open', 'paid']),
                                       ('period_id', '=', self.period_id.id),
                                       ('date_invoice', '>=', self.date_from),
                                       ('date_invoice', '<=', self.date_to),
        ...
        for company in self.env['res.company'].browse(companies):
            if company.codcaen.code.zfill(4) in caens:
                ...
                for cota in obj_tax.browse(cotas):
                    ...
                    inv_lines = obj_inv_line.search([('invoice_id', 'in', cota_inv.ids)])
                    bazab = bazas = tvab = tvas = 0
                    for line in inv_lines:
                        inv_curr = line.invoice_id.currency_id.with_context({'date': inv_date})
                        inv_date = line.invoice_id.date_invoice
                        if line.product_id.type in ('product', 'consumables'):
                            bazab += inv_curr.compute(line.price_subtotal, comp_curr)
                            tvab += inv_curr.compute(
                                line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                        else:
                            bazas += inv_curr.compute(line.price_subtotal, comp_curr)
                            tvas += inv_curr.compute(
                                line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                    if bazab != 0:
                        bdict = {
    ...
    def _generate_facturi(self):
        ...
        invoices = invoices1.filtered(
            lambda r: r.amount_total < 0 or r.state == 'cancel' or r.journal_id.sequence_type in (
                'autoinv1', 'autoinv2'))
        for inv in invoices:
            ...
            inv_curr = inv.currency_id.with_context({'date': inv_date})
            inv_type = False
                ...
                for line in inv.invoice_line:
                    ...
                    for cota in cotas:
                        ...
                        if cota_amount in (5, 9, 19, 20, 24):
                            if cota_amount == 24:
                                baza24 += inv_curr.compute(line.price_subtotal,
                                                           comp_curr)
                                tva24 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            elif cota_amount == 20:
                                baza20 += inv_curr.compute(line.price_subtotal, comp_curr)
                                tva20 += inv_curr.compute(
                                ...
                                baza19 += inv_curr.compute(line.price_subtotal,
                                                           comp_curr)
                                tva19 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            elif cota_amount == 9:
                                baza9 += inv_curr.compute(line.price_subtotal,
                                                          comp_curr)
                                tva9 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                            elif cota_amount == 5:
                                baza5 += inv_curr.compute(line.price_subtotal,
                                                          comp_curr)
                                tva5 += inv_curr.compute(
                                    line.price_normal_taxes and line.price_normal_taxes or line.price_taxes, comp_curr)
                new_dict = {
    ...
    def _get_datas(self):
        ...
        if user.partner_id.function:
            ...
            raise RedirectWarning(msg, action.with_context({'res_id': user.partner_id.id}).id,
                                  _('Go to the partner form.'))
        ...
        xmldict.update({
            ...
            'tip_D394': "L",
            'sistemTVA': int(comm_partner.with_context(ctx1)._check_vat_on_payment()),
            'caen': company.codcaen.code.zfill(4),
            'cui': comm_partner.vat[2:],
            'den': comm_partner.name,
            'adresa': ', '.join([                comm_partner.state_id and comm_partner.state_id.name,
                comm_partner.city,
                comm_partner.street,
                comm_partner.zip]),
            'totalPlata_A': 0,
        ...
        if int_partner.is_company:
            xmldict.update({'calitate_intocmit': int_partner.function or '', })
        else:
            xmldict.update({'functie_intocmit': int_partner.function or '', })

        if self.anaf_cross_new_opt:
            xmldict.update({'schimb_optiune': int(self.anaf_cross_new_opt), })
        if company.phone:
            xmldict.update({'telefon': comm_partner.phone})
        if company.fax and company.fax != '-':
            xmldict.update({'fax': comm_partner.fax, })
        if company.email:
            xmldict.update({'mail': comm_partner.email, })

        if comm_partner.id != decl_partner.id:
            xmldict.update({'cifR': decl_partner.vat[2:],
                            'denR': decl_partner.name,
                            'functie_reprez': decl_partner.function,
                            'adresaR': ', '.join([decl_partner.state_id and decl_partner.state_id.name,
                                                  decl_partner.city,
                                                  decl_partner.street,
                                                  decl_partner.zip]),
            ...
            xmldict.update({'denR': comm_partner.name,
        ...
        invoices = obj_invoice.search([('state', 'in', ['open', 'paid']),
                                       ('period_id', '=', period.id),
                                       ('fiscal_receipt', '=', False),
                                       ('date_invoice', '>=', self.date_from),
                                       ('date_invoice', '<=', self.date_to),
        ...
        invoices1 = False
        op2 = []
        if fields.Date.from_string(self.period_id.date_start) < fields.Date.from_string('2016-10-01'):
            op1 = [d for d in self._get_op1(invoices) if d['tip_partener'] == '1']
        else:
            invoices1 = obj_invoice.search([('type', 'in', ('out_invoice', 'out_refund')),
                                            ('fiscal_receipt', '=', True),
        ...
        totalPlataA = 0
        totalPlataA += informatii['nrCui1'] + informatii['nrCui2'] + informatii['nrCui3'] + informatii['nrCui4']
        for line in rezumat2:
            totalPlataA += line['bazaA'] + line['bazaL'] + line['bazaAI']
        xmldict.update({'totalPlata_A': int(totalPlataA),
...
xmlns="mfp:anaf:dgti:d394:declaratie:v3" """
        for key, val in xml_data.iteritems():
            if key not in ('informatii', 'rezumat1', 'rezumat2', 'serieFacturi', 'lista', 'facturi', 'op1', 'op2'):
...
<op2 """
        ...
        model_data_ids = mod_obj.search([('model', '=', 'ir.ui.view'), ('name', '=', 'view_d394_new_save')])
